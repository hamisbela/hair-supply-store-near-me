...
const ContactPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Contact Hair Supply Store Near Me | Get Support & Information</title>
        <meta name="description" content="Contact HairSupplyStoreNearMe.com for questions, support, or information about our hair and beauty supply store directory." />
      </Helmet>
      ...
      <main className="container mx-auto px-4 py-12">
        <header className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Get in touch with the HairSupplyStoreNearMe.com team
          </p>
        </header>
          ...
          <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@hairsupplystorenearme.com" className="text-indigo-600 hover:text-indigo-800">
                      info@hairsupplystorenearme.com
                    </a>
                    <p className="text-gray-600 mt-2">For business listings:</p>
                    <a href="mailto:listings@hairsupplystorenearme.com" className="text-indigo-600 hover:text-indigo-800">
                      listings@hairsupplystorenearme.com
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-indigo-50 p-8 rounded-lg">
              ...
              <p className="text-gray-700 mb-4">
                Stay connected with us on social media for the latest updates, tips, and news about hair care and beauty supplies.
              </p>
        ...
        <div className="max-w-4xl mx-auto mt-12">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-lg text-gray-800">How do I find hair supply stores near me?</h3>
                <p className="text-gray-700 mt-2">
                  You can find local hair supply stores by using our search function on the homepage. Simply enter your city or zip code to discover quality beauty supply shops in your area.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mt-2">
                  You can add your hair supply store by visiting our <a href="/add-a-listing/" className="text-indigo-600 hover:text-indigo-800">Add a Listing</a> page and completing the submission form with your business details.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mt-2">
                  To update your business information, please contact us at listings@hairsupplystorenearme.com with your business name and the changes you'd like to make.
                </p>
              </div>
