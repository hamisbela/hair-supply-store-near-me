...
const AddListingPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Add Your Hair Supply Store | List Your Business in Our Directory</title>
        <meta name="description" content="Add your hair supply store to our directory. Reach new customers looking for quality hair care products in your area." />
      </Helmet>

      <main className="container mx-auto px-4 py-12">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-indigo-900">Add Your Business Listing</h1>
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Join our directory of professional hair supply stores and connect with potential customers searching for "hair supply store near me"
          </p>
        </header>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <form>
              <h2 className="text-2xl font-bold text-indigo-800 mb-6">Business Information</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="hair_salon">Hair Salon with Retail</option>
                    <option value="barber_shop">Barber Shop with Supplies</option>
                    <option value="wig_shop">Wig & Hair Extension Shop</option>
                    <option value="professional_supply">Professional Beauty Supply</option>
                    <option value="ethnic_hair">Ethnic Hair Care Specialist</option>
              ...
              <h2 className="text-2xl font-bold text-indigo-800 mb-6">Business Details</h2>
              ...
              <div className="mb-8">
                ...
                <textarea 
                  id="products"
                  rows={3}
                  placeholder="List your product categories, brands, and specialties..."
                  required
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ></textarea>
              </div>
          ...
          <div className="mt-12 bg-indigo-50 p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-700">Gain exposure to potential customers actively searching for hair supply stores near them.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-700">Connect with customers specifically looking for hair care products in their area.</p>
              </div>
