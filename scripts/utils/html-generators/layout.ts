...
<head>
  ...
  <title>${title}</title>
  <link rel="icon" type="image/png" href="https://img.icons8.com/fluency/48/comb.png" />
      ...
      <nav class="flex justify-between items-center">
        <div>
          <a href="/" class="text-2xl font-bold flex items-center">
            ...
            <span class="hidden md:inline">HairSupplyStoreNearMe.com</span>
            <span class="md:hidden">Hair Supply</span>
          </a>
        </div>
    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-xl font-bold mb-4">
            <span class="block">Hair Supply Store</span>
            <span class="block">NearMe.com</span>
          </h3>
          <p class="text-indigo-200">Find the best hair supply stores and beauty supply shops in your area.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-2">
            <ul class="space-y-2">
              <li><a href="/states/california/" class="text-indigo-200 hover:text-white">California</a></li>
              <li><a href="/states/new-york/" class="text-indigo-200 hover:text-white">New York</a></li>
              <li><a href="/states/florida/" class="text-indigo-200 hover:text-white">Florida</a></li>
              <li><a href="/states/texas/" class="text-indigo-200 hover:text-white">Texas</a></li>
              <li><a href="/states/illinois/" class="text-indigo-200 hover:text-white">Illinois</a></li>
              <li><a href="/states/pennsylvania/" class="text-indigo-200 hover:text-white">Pennsylvania</a></li>
            </ul>
            <ul class="space-y-2">
              <li><a href="/states/ohio/" class="text-indigo-200 hover:text-white">Ohio</a></li>
              <li><a href="/states/georgia/" class="text-indigo-200 hover:text-white">Georgia</a></li>
              <li><a href="/states/michigan/" class="text-indigo-200 hover:text-white">Michigan</a></li>
              <li><a href="/states/north-carolina/" class="text-indigo-200 hover:text-white">North Carolina</a></li>
              <li><a href="/states/new-jersey/" class="text-indigo-200 hover:text-white">New Jersey</a></li>
              <li><a href="/states/arizona/" class="text-indigo-200 hover:text-white">Arizona</a></li>
            </ul>
          </div>
        </div>
        <div>
          ...
          <div class="grid grid-cols-2 gap-2">
            <ul class="space-y-2">
              <li><a href="/cities/new-york/" class="text-indigo-200 hover:text-white">New York</a></li>
              <li><a href="/cities/los-angeles/" class="text-indigo-200 hover:text-white">Los Angeles</a></li>
              <li><a href="/cities/chicago/" class="text-indigo-200 hover:text-white">Chicago</a></li>
              <li><a href="/cities/houston/" class="text-indigo-200 hover:text-white">Houston</a></li>
              <li><a href="/cities/phoenix/" class="text-indigo-200 hover:text-white">Phoenix</a></li>
              <li><a href="/cities/philadelphia/" class="text-indigo-200 hover:text-white">Philadelphia</a></li>
            </ul>
            <ul class="space-y-2">
              <li><a href="/cities/san-antonio/" class="text-indigo-200 hover:text-white">San Antonio</a></li>
              <li><a href="/cities/san-diego/" class="text-indigo-200 hover:text-white">San Diego</a></li>
              <li><a href="/cities/dallas/" class="text-indigo-200 hover:text-white">Dallas</a></li>
              <li><a href="/cities/san-jose/" class="text-indigo-200 hover:text-white">San Jose</a></li>
              <li><a href="/cities/austin/" class="text-indigo-200 hover:text-white">Austin</a></li>
              <li><a href="/cities/jacksonville/" class="text-indigo-200 hover:text-white">Jacksonville</a></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="mt-12 pt-8 border-t border-indigo-800 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="flex space-x-6 text-2xl justify-center md:justify-start">
          <a href="#" class="text-indigo-200 hover:text-white"><i class="fab fa-facebook"></i></a>
          ...
          <a href="#" class="text-indigo-200 hover:text-white"><i class="fab fa-linkedin"></i></a>
        </div>
  ...
  <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:-translate-y-1 hover:shadow-lg">
    ...
    <div class="p-4">
      ...
      <p class="text-gray-600 mb-2">
        <i class="fas fa-map-marker-alt text-indigo-500 mr-2"></i>${cityState || 'Location unavailable'}
      </p>
      ${categories ? `<p class="text-gray-600 mb-3"><i class="fas fa-tag text-indigo-500 mr-2"></i>${categories}</p>` : ''}
      <div class="mt-4 flex justify-between items-center">
        <div>
          ${salon.telephone ? `<a href="tel:${salon.telephone}" class="text-indigo-500 hover:text-indigo-700"><i class="fas fa-phone mr-1"></i> Call</a>` : ''}
        </div>
        <a href="${getSalonUrl(salonSlug)}" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition-colors">View Details</a>
      </div>
    </div>
  </div>`;
}
